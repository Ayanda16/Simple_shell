...
int execute(char **args, char **string);
...
/* Builtins */
int (*get_builtin(char *command))(char **args, char **string);
...
int cd_b(char **args, char __attribute__((__unused__)) **string);
int alias_b(char **args, char __attribute__((__unused__)) **string);
int help_b(char **args, char __attribute__((__unused__)) **string);
